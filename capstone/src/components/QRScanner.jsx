    ...
    return (
        <>
            {isMobileView ? (
                <button
                    onClick={onScanClick}
                    className="flex items-center justify-center gap-3 bg-blue-500 hover:bg-blue-600 text-white font-semibold py-6 px-8 rounded-lg transition-colors duration-200 text-xl"
                >
